...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    // logo: 'https://cdn.jsdelivr.net/gh/weiluoliang/img@main/blog/book.webp', // 导航栏logo
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:luoliang.wei@foxmail.com',
        },
        {
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: 'Java,个人技术博客,技术文档,学习,面试,后端技术',
      },
    ],
